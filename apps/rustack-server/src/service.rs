...
mod s3_router {
    ...
    use rustack_s3_http::{dispatch::S3Handler, service::S3HttpService};
...
mod dynamodb_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_dynamodb_http::{dispatch::DynamoDBHandler, service::DynamoDBHttpService};
...
mod dynamodbstreams_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_dynamodbstreams_http::{
...
mod sqs_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_sqs_http::{dispatch::SqsHandler, service::SqsHttpService};
...
mod ssm_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_ssm_http::{dispatch::SsmHandler, service::SsmHttpService};
...
mod sns_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_sns_http::{dispatch::SnsHandler, service::SnsHttpService};
...
mod lambda_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_lambda_http::{dispatch::LambdaHandler, service::LambdaHttpService};
...
mod events_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_events_http::{dispatch::EventsHandler, service::EventsHttpService};
...
mod logs_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_logs_http::{dispatch::LogsHandler, service::LogsHttpService};
...
mod kms_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_kms_http::{dispatch::KmsHandler, service::KmsHttpService};
...
mod kinesis_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_kinesis_http::{dispatch::KinesisHandler, service::KinesisHttpService};
...
mod secretsmanager_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_secretsmanager_http::{
...
mod ses_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_ses_http::{dispatch::SesHandler, service::SesHttpService, v2::SesV2HttpService};
        ...
        ) -> Pin<Box<dyn Future<Output = Result<http::Response<GatewayBody>, Infallible>> + Send>>
        {
            ...
            Box::pin(async move {
                ...
                .await
                {
                    ...
                    Err(e) => {
                        let status = match &e {
                            rustack_apigatewayv2_core::error::ApiGatewayV2ServiceError::NotFound(_) => {
                                http::StatusCode::NOT_FOUND
                            }
                            rustack_apigatewayv2_core::error::ApiGatewayV2ServiceError::BadRequest(_) => {
...
mod cloudwatch_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_cloudwatch_http::{dispatch::CloudWatchHandler, service::CloudWatchHttpService};
...
mod iam_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_iam_http::{dispatch::IamHandler, service::IamHttpService};
...
mod sts_router {
    ...
    use http_body_util::BodyExt;
    use hyper::{body::Incoming, service::Service};
    use rustack_sts_http::{dispatch::StsHandler, service::StsHttpService};
