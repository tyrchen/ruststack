...
/// Response body for SQS HTTP responses.
///
/// All SQS responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum SqsResponseBody {
...
impl SqsResponseBody {
    ...
    /// Create a response body from JSON bytes.
    #[must_use]
...
impl http_body::Body for SqsResponseBody {
    type Data = Bytes;
