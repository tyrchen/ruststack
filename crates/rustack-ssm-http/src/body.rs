...
/// Response body for SSM HTTP responses.
///
/// All SSM responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum SsmResponseBody {
...
impl http_body::Body for SsmResponseBody {
    type Data = Bytes;
