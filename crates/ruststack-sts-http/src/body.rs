...
/// Response body for STS HTTP responses.
///
/// All STS responses are either XML (buffered) or empty.
#[derive(Debug, Default)]
pub enum StsResponseBody {
...
impl http_body::Body for StsResponseBody {
    type Data = Bytes;
