...
/// Response body for Kinesis HTTP responses.
///
/// All Kinesis responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum KinesisResponseBody {
...
impl http_body::Body for KinesisResponseBody {
    type Data = Bytes;
