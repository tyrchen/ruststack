...
/// Response body for KMS HTTP responses.
///
/// All KMS responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum KmsResponseBody {
...
impl http_body::Body for KmsResponseBody {
    type Data = Bytes;
