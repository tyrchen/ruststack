...
///
/// ```
/// let id = rustack_iam_core::id_gen::generate_iam_id("AIDA");
...
///
/// ```
/// let key = rustack_iam_core::id_gen::generate_access_key_id();
...
///
/// ```
/// let secret = rustack_iam_core::id_gen::generate_secret_access_key();
