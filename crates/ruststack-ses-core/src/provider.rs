...
#[cfg(test)]
mod tests {
    use ruststack_ses_model::types::{Body, Content, Destination, Message, Template};

    use super::*;

    fn make_provider() -> RustStackSes {
        RustStackSes::new(SesConfig::default())
    }
    ...
    fn test_should_reject_unverified_in_strict_mode() {
        let p = RustStackSes::new(SesConfig {
