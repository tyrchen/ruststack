...
/// Response body for EventBridge HTTP responses.
///
/// All EventBridge responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum EventsResponseBody {
...
impl http_body::Body for EventsResponseBody {
    type Data = Bytes;
