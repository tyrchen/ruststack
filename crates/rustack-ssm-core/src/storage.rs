...
impl ParameterStore {
        ...
        if let Some(mut record) = self.parameters.get_mut(name) {
            ...
            if record.parameter_type != parameter_type {
                return Err(SsmError::with_message(
                    rustack_ssm_model::error::SsmErrorCode::HierarchyTypeMismatch,
                    format!(
            ...
            if record.versions.len() >= MAX_VERSIONS {
                ...
                if let Some(oldest_key) = oldest_unlabeled {
                    ...
                    return Err(SsmError::with_message(
                        rustack_ssm_model::error::SsmErrorCode::ParameterMaxVersionLimitExceeded,
                        format!(
    ...
    pub fn get_parameters_by_path(
        ...
        path: &str,
        recursive: bool,
        filters: &[rustack_ssm_model::types::ParameterStringFilter],
        max_results: usize,
...
mod tests {
    ...
    fn test_should_reject_duplicate_without_overwrite() {
        ...
        assert_eq!(
            err.code,
            rustack_ssm_model::error::SsmErrorCode::ParameterAlreadyExists,
        );
    }
    ...
    fn test_should_delete_parameter() {
        ...
        assert_eq!(
            err.code,
            rustack_ssm_model::error::SsmErrorCode::ParameterNotFound,
        );
    }
    ...
    fn test_should_reject_tags_on_nonexistent_parameter() {
        ...
        assert_eq!(
            err.code,
            rustack_ssm_model::error::SsmErrorCode::InvalidResourceId,
        );
    }
    ...
    fn test_should_enforce_tag_limit() {
        ...
        assert_eq!(
            err.code,
            rustack_ssm_model::error::SsmErrorCode::TooManyTagsError,
        );
    }
    ...
    fn test_should_enforce_label_limit() {
        ...
        assert_eq!(
            err.code,
            rustack_ssm_model::error::SsmErrorCode::ParameterVersionLabelLimitExceeded,
        );
    }
