//! Secrets Manager HTTP response body type.
...
/// Response body for Secrets Manager HTTP responses.
///
/// All Secrets Manager responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum SecretsManagerResponseBody {
...
impl SecretsManagerResponseBody {
...
impl http_body::Body for SecretsManagerResponseBody {
    type Data = Bytes;
