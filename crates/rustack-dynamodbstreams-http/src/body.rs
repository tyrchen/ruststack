...
/// Response body for DynamoDB Streams HTTP responses.
///
/// All DynamoDB Streams responses are either JSON (buffered) or empty.
#[derive(Debug, Default)]
pub enum DynamoDBStreamsResponseBody {
...
impl DynamoDBStreamsResponseBody {
...
impl http_body::Body for DynamoDBStreamsResponseBody {
    type Data = Bytes;
