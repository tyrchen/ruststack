...
/// Response body for Lambda HTTP responses.
///
/// All Lambda responses are either JSON (buffered) or empty (for 204 responses).
#[derive(Debug, Default)]
pub enum LambdaResponseBody {
...
impl http_body::Body for LambdaResponseBody {
    type Data = Bytes;
