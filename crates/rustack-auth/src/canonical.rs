...
///
/// ```
/// use rustack_auth::canonical::build_canonical_request;
///
...
///
/// ```
/// use rustack_auth::canonical::build_canonical_uri;
///
...
///
/// ```
/// use rustack_auth::canonical::build_canonical_query_string;
///
...
///
/// ```
/// use rustack_auth::canonical::build_canonical_headers;
///
/// let headers = vec![
///     ("Host", "example.com"),
...
///
/// ```
/// use rustack_auth::canonical::build_signed_headers_string;
///
/// assert_eq!(
