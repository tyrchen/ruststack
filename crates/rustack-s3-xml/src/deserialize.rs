...
impl S3Deserialize for Grantee {
    fn deserialize_xml(reader: &mut Reader<&[u8]>) -> Result<Self, XmlError> {
        ...
        let mut id = None;
        let mut grantee_type = rustack_s3_model::types::Type::default();
        let mut uri = None;
                ...
                Event::Start(e) => {
                    ...
                    match tag_name {
                        ...
                        "Type" => {
                            ...
                            grantee_type = rustack_s3_model::types::Type::from(text.as_str());
                        }
                        _ => skip_element(reader)?,
                    }
                }
                    ...
                    match tag_name {
                        "PartitionDateSource" => {
                            ...
                            partition_date_source = Some(
                                rustack_s3_model::types::PartitionDateSource::from(text.as_str()),
                            );
                        }
                        _ => skip_element(reader)?,
                    }
