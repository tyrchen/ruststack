...
/// Response body for IAM HTTP responses.
///
/// All IAM responses are either XML (buffered) or empty.
#[derive(Debug, Default)]
pub enum IamResponseBody {
...
impl http_body::Body for IamResponseBody {
    type Data = Bytes;
