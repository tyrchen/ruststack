...
///
/// ```
/// use rustack_s3_core::validation::validate_bucket_name;
///
...
///
/// ```
/// use rustack_s3_core::validation::validate_tag_key;
///
...
///
/// ```
/// use rustack_s3_core::validation::validate_tag_value;
///
...
///
/// ```
/// use rustack_s3_core::validation::validate_tags;
///
/// let tags = vec![
...
///
/// ```
/// use rustack_s3_core::validation::validate_content_md5;
///
/// // No header → always OK
